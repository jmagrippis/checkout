...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Checkout = __webpack_require__(180);

	var _Checkout2 = _interopRequireDefault(_Checkout);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var progressSteps = [{ id: 1, current: true, text: "Basket" }, { id: 2, current: false, text: "Your Details" }, { id: 3, current: false, text: "Payment" }, { id: 4, current: false, text: "Complete" }];

	var formSections = [{ id: 1, label: "Existing Customer Log In", expandable: true, expanded: true }, { id: 2, label: "New Customer Registration" }];

	var store = (0, _redux.createStore)(_reducers2.default, { progressSteps: progressSteps, formSections: formSections });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formSections = __webpack_require__(178);

	var _formSections2 = _interopRequireDefault(_formSections);

	var _progressSteps = __webpack_require__(179);

	var _progressSteps2 = _interopRequireDefault(_progressSteps);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var checkoutApp = (0, _redux.combineReducers)({
	  formSections: _formSections2.default,
	  progressSteps: _progressSteps2.default
	});
...
/***/ function(module, exports) {
	...
	var formSection = function formSection(state, action) {
	  switch (action.type) {
	    case "TOGGLE_SECTION":
	...
	var formSections = function formSections() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	  var action = arguments[1];
...
/***/ function(module, exports) {
	...
	var progressStep = function progressStep(state, action) {
	  switch (action.type) {
	    case "CHANGE_STEP":
	      if (state.id === action.nextStep && state.current === true || state.id !== action.nextStep && state.current === false) {
	        return state;
	      }
	...
	var progressSteps = function progressSteps() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	  var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FlexContainer = __webpack_require__(181);

	var _FlexContainer2 = _interopRequireDefault(_FlexContainer);

	var _ProgressStepList = __webpack_require__(182);

	var _ProgressStepList2 = _interopRequireDefault(_ProgressStepList);

	var _BrandButtonLarge = __webpack_require__(184);

	var _BrandButtonLarge2 = _interopRequireDefault(_BrandButtonLarge);
	...
	var Checkout = function Checkout(_ref) {
	  var formSections = _ref.formSections;
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ProgressStepList2.default, null),
	        _react2.default.createElement(_BrandButtonLarge2.default, { text: "Proceed to the next step", onClick: function onClick() {
	            return dispatch((0, _actions.nextStep)());
	          } })
	      )
	    ),
	    formSections.map(function (formSection) {
	      return _react2.default.createElement(_FormSection2.default, _extends({
	        key: formSection.id
	      }, formSection));
	    })
	  );
	...
	Checkout.propTypes = {
	  dispatch: _react.PropTypes.func.isRequired,
	  formSections: _react.PropTypes.array.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	FlexContainer.propTypes = {
	  ...
	  flexDirection: _react.PropTypes.string
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProgressStep = __webpack_require__(183);

	var _ProgressStep2 = _interopRequireDefault(_ProgressStep);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ProgressStepList = function ProgressStepList(_ref) {
	  var progressSteps = _ref.progressSteps;
	  return _react2.default.createElement(
	    "ul",
	    null,
	    progressSteps.map(function (progressStep) {
	      return _react2.default.createElement(_ProgressStep2.default, _extends({
	        key: progressStep.id
	      }, progressStep));
	    })
	  );
	...
	ProgressStepList.propTypes = {
	  progressSteps: _react.PropTypes.arrayOf(_react.PropTypes.shape({
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(ProgressStepList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BrandButtonLarge = function BrandButtonLarge(_ref) {
	...
	exports.default = BrandButtonLarge;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Expander = __webpack_require__(186);
	...
	var FormSection = function FormSection(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    expandable ? _react2.default.createElement(_Expander2.default, { expanded: expanded, onClick: function onClick() {
	        return dispatch((0, _actions.toggleSection)(id));
	      } }) : "",
	    _react2.default.createElement(
	      "p",
	      null,
	...
	exports.default = (0, _reactRedux.connect)()(FormSection);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styles = function styles(expanded) {
	  return {
...
/***/ function(module, exports) {
	...
	var changeStep = exports.changeStep = function changeStep(nextStep) {
	...
	var toggleSection = exports.toggleSection = function toggleSection(id) {
	  return {
	    type: "TOGGLE_SECTION",
	    id: id
	  };
